...
//        System.out.println("In JSON.parse(String text) text: " + text);
//        System.out.println("         DEFAULT_PARSER_FEATURE: " + DEFAULT_PARSER_FEATURE);
...
//        System.out.println("In JSON.parse(String text, ParserConfig config, int features) text: " + text);
//        System.out.println("                                                            config: " + config.toString());
//        System.out.println("                                                          features: " + features);

        DefaultJSONParser parser = new DefaultJSONParser(text, config, features);
        Object value = parser.parse();
//        System.out.println("                                              value before resolve: " + value.toString());

        parser.handleResovleTask(value);
//        System.out.println("                                               value after resolve: " + value.toString());
...
//        System.out.println("In JSON.parse(String text, int features) text: " + text);
//        System.out.println("             ParserConfig.getGlobalInstance(): " + ParserConfig.getGlobalInstance().toString());
